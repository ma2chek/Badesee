...
public class DetailActivity extends Activity {
	...
	/**
	 * Is used to set Datas from the Badestellen-Object to the GUI-Elements
	 */
	private void setData() {
		...
		while (aktuelleBadestelle == null) {
			...
			TextView profil = (TextView) findViewById(R.id.TextViewCustomFont_detail_head_text_profil);

			TextView badestelle = (TextView) findViewById(R.id.TextViewCustomFont_detail_head_text_badestelle);
			TextView bezirk = (TextView) findViewById(R.id.TextViewCustomFont_detail_content_bezirk_text);
			TextView datum = (TextView) findViewById(R.id.TextViewCustomFont_detail_content_bezirk_datum);
			TextView ecoli = (TextView) findViewById(R.id.TextViewCustomFont_detail_content_ecoli_text);
			TextView enterokokken = (TextView) findViewById(R.id.TextViewCustomFont_detail_content_enterokokken_text);
			TextView sichttiefe = (TextView) findViewById(R.id.TextViewCustomFont_detail_content_sichttiefe_text);
