 ...
 * 
 *         Shows fundamental Informations and coordinate insae a GoogleMap
 */
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dragList.setOnItemDragListener(new OnItemDragListener() {
			...
			/**
			 * Implements the ListItem drag functionality.
			 * 
			 * @param position
			 *            Position of the dragged ListItem
			 * @param hswipe
			 *            Horizontal movement (related to SreenWith)
			 * @param view
			 *            View of the dragged Object
			 */
			@Override
			...
			/**
			 * Implements the ListItem Mouse/Touch-Up functionality.
			 * 
			 * @param position
			 *            Position of the dragged ListItem
			 * @param view
	...
	/**
	 * Initialize the GoogleMap-Fragment. Adds the markers based on the
	 * Badestellen-coordinates.
	 */
	...
	/**
	 * Extracts the relevant Informations provided by the JSON-File and
	 * generates Badestellen-Objects
	 */
